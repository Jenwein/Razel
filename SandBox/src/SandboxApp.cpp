...
public:
	...
	void OnUpdate(Razel::Timestep ts) override
	{
		...
		RZ_CORE_TRACE("CameraPosition: {0},{1},{2}",m_CameraPosition.x, m_CameraPosition.y, m_CameraPosition.z);
		RZ_CORE_TRACE("CameraRotation: {0}", m_CameraRotation);
			
		Razel::Renderer::BeginScene(m_Camera);
		Razel::Renderer::Submit(m_BlueShader, m_SquareVA); // BindVAO & DrawElem
