...
#define RZ_INTERNAL_ASSERT_NO_MSG(type, check) RZ_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", RZ_STRINGIFY_MACRO(check), ::Razel::Assert::CurrentFileName(__FILE__), __LINE__)
